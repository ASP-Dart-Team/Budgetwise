                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: constraints.maxHeight * 0.02),
                          const Text(
                            'Enter the percentage distribution for Essentials',
                            style: TextStyle(fontSize: 18),
                            textAlign: TextAlign.start,
                          ),
                          SizedBox(height: constraints.maxHeight * 0.02),
                          ...
                          SizedBox(height: constraints.maxHeight * 0.02),
                          const Text(
                            'Enter the percentage distribution for Expenditures',
                            style: TextStyle(fontSize: 18),
                            textAlign: TextAlign.start,
                          ),
                          SizedBox(height: constraints.maxHeight * 0.02),
                          ...
                          SizedBox(height: constraints.maxHeight * 0.02),
                          const Text(
                            'Enter the percentage distribution for Investment',
                            style: TextStyle(fontSize: 18),
                            textAlign: TextAlign.start,
                          ),
                          SizedBox(height: constraints.maxHeight * 0.02),
                          ...
                          SizedBox(height: constraints.maxHeight * 0.02),
                          const Text(
                            'If the percentage distributions for Essentials, Expenditures, and Investments are not provided, default values of 50%, 30%, and 20% will be assumed, respectively.',
