  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        backgroundColor: Color.fromARGB(255, 215, 153, 226),
        body: SafeArea(
          child: LayoutBuilder(
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                  gradient: LinearGradient(
                                    colors: [
                                      Color.fromARGB(255, 183, 94,
                                          199), // Set your gradient colors
                                      Color.fromARGB(255, 113, 75, 179),
                                      Color.fromARGB(255, 201, 89, 221),
                                    ],
